...
varvar gpuModifierDefs = [
    ...
    { name: "angleY", value: 0.0, code: "angleY += angleY_value;" },
    { name: "angleZ", value: 0.0, code: "angleZ += angleZ_value;" },
    { name: "scaleX", value: 1.0, code: "scaleX *= scaleX_value;", defaultValue: 1.0 },
    { name: "scaleY", value: 1.0, code: "scaleY *= scaleY_value;", defaultValue: 1.0 },
	...
	{ name: "incomingAngleX", value: 0.0, code: "incomingAngleX += incomingAngleX_value;" },
	{ name: "incomingAngleY", value: 0.0, code: "incomingAngleY += incomingAngleY_value;" },
...
public function getGpuModDef(name:String) {
    for (mod in gpuModifierDefs) {
        if (mod.name == name)
            return mod;
    }
    return null;
...
public function setupFromJson(data:Dynamic) {
    if (data == null || data.modchart == null)
        return;

    var events = cast(data.modchart, Array<Dynamic>);
...
/*
all this credits to TheZoroForce240 or whoever made it lol
*/
